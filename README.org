...
#+END_SRC
   ...
   current scope is very common. Let's create a special syntax for it. =@= is
   chosen as resembling =deref= from Clojure:
...
#+END_SRC
   ...
   Also useful to have live constant (sorry for oxymoron) counterpart:
